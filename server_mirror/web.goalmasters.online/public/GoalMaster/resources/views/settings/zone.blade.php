                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group control-group form-inline ">
                            ...
                            <div class="col-md-9 controls">
                                <input type="text" id="name" name="name" placeholder="{{translate('Zone name')}}" required class="form-control input-full" data-validation-required-message="Zone name is required" />
                ...
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <button id="btnAdd" class="btn btn-primary btn-sm btn-round ml-auto">
                            <i class="fa fa-plus"></i> {{translate('Add New Zone')}}
                        </button>
                    </div>
                </div>
                <div class="card-body">
...
@push("adminScripts")
<script src="{{ dsAsset('js/custom/settings/zone.js') }}"></script>
@endpush
@endsection